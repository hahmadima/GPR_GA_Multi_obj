...
% Create scatter
scatter1 = scatter(X1,Y1,'DisplayName','Actual vs predicted');
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','  Regression line','Tag','Linear regression analysis',...
    'Parent',axes1,...
    'Color',[0 0 0]);
...
text(.05,.95,txt,'parent',axesh1, ...lin
